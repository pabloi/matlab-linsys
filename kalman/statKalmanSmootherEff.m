function [Xs,Ps,Pt,Xf,Pf,Xp,Pp,rejSamples]=statKalmanSmootherEff(Y,A,C,Q,R,x0,P0,B,D,U,outRejFlag,constFun)
...
warning('Using statKalmanSmootherEff, but backward pass has not been implemented to be efficient. Falling back to standard smoother')
  %Init missing params:

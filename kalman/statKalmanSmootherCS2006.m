function [Xs,Ps,Pt,logL]=statKalmanSmootherCS2006(Y,A,C,Q,R,varargin)
...
[Lik,Xs,Ps,Pt] = SmoothLDS(LDS,{Y_D},{U},{U}); %Mex version (requires building from mex, see README in lds-1.1)
Xs=Xs{1};
Ps=Ps{1};
Pt=Pt{1};

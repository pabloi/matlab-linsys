...
%
% Data:
%          The data is contained in the file appl5.mat
%          
%          We are grateful to Hendrik Van Brussel and Jan Swevers 
%          of the laboratory of Production Engineering, Machine 
%          Design and Automation of the Katholieke
...
ax_id = [1:800];n_id = length(ax_id); 	% Identification axis
ax_val = [801:1024];n_val = length(ax_val); % Validation axis
...
show_res('Flexible robot arm',m,l,n_id,n_val,...

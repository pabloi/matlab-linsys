...
%
% Data:
%          The data is contained in the file appl3.mat
%          
% Copyright: 
...
ax_val = [901:1247];n_val = length(ax_val); % Validation axis
...
disp(' ')
disp('      The following optimization took 10 minutes on a Pentium')  
disp(' ')  
...
show_res('Glass Oven',m,l,n_id,n_val,...
